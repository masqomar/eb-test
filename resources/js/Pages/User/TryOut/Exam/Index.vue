                ...
                <div class="col-xs-12 col-sm-6 col-md-6 col-lg-3" v-for="(exam, index) in exams.data" :key="index">
                    <div class="card border-bottom border-3 border-0">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text">Kerjakan Soal Sesuai Intruksi Yang Ada Dalam Informasi.</p>
                            <hr>
                            <div class="text-center">
                                ...
                                <div v-else>
                                    <h5 v-if="exam.price === 0"><span class="badge badge-pill bg-success ms-1">Gratis</span></h5>
                                    <h5 v-else><span class="badge badge-pill bg-danger ms-1">Rp. {{ formatPrice(exam.price) }}</span></h5>
                                </div>
                            ...
                            <div class="text-center">
                                ...
                                <div v-if="exam.transaction.length > 0 || exam.price === 0">
