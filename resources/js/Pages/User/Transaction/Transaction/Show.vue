								...
								<main>
									...
									<div class="notices">
										...
										<div class="notice">
                                            ...
                                            Setelah melakukan pembayaran, silakan lakukan konfirmasi melalui Whatsapp di <b>{{ wa }}</b> dengan menyertakan nomor faktur serta bukti transfer pembayaran. terimakasih
                                        </div>
									</div>
                                    <h5>
                                    </h5>
