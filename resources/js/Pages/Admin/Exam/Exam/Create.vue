<template>
    <Head>
        <title>{{ appName }} - Tambah Ujian</title>
    </Head>
    <!--start page wrapper -->
                ...
                <div class="card-body">
                    ...
                    <form @submit.prevent="submit" class="row g-3">
                        ...
                        <div class="col-12">
                            ...
                            <Editor
                                api-key="jd1k1wkrqz97iboswell3mi4br146c6g7vq60g3l3l0vid0w"
                                v-model="form.description"
                                :init="{
                                    images_upload_url: 'https://englishboosterofficial.com/admin/upload_files',
